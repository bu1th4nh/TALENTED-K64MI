...
\subsection{Thuật toán và chương trình}
    \begin{frame}[fragile, label = jacobi.algo]  
        ...
        \IncMargin{1em}\begin{algorithm}[H]
            ...
            \Begin{
                ...
                $ \lambda \longleftarrow $ \hyperlink{jacobi.getNorm}{getLambda}$(A, p) $\;
                \BlankLine
        ...
        \hyperlink{jacobi.code}{\textcolor{blue}{Chuyển sang phần code}}
    \end{frame}

    

    \begin{frame}[fragile, label = jacobi.checkDom]
    ...
    \end{frame}
    \begin{frame}[fragile, label = jacobi.getNorm]
        \IncMargin{1em}\begin{function}[H]
        ...
        \hyperlink{jacobi.algo}{\textcolor{blue}{Trở về thuật toán chính}}
    \end{frame}
    \begin{frame}[fragile, label = jacobi.iterate]
    ...
    \begin{frame}[label = jacobi.code]
        \frametitle{Chương trình}
        \begin{center}
            \includegraphics[scale = 0.4]{jacobi-code-qr.png}

            \url{https://github.com/bu1th4nh/TALENTED-K64MI/blob/master/MI3040/report-code/jacobian.py}
        \end{center}

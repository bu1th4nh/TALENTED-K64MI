...
class HopcroftKarpMatching
{
    ...
    long long nIterations;
    long long nOuterLoops;
...
public:
    ...
    long long extract_DFS_steps()
    {
        /** \brief Trích xuất số lần DFS
        */
        return nIterations;
    }
    long long extract_outer_loops_steps()
    {
        /** \brief Trích xuất số lần lặp vòng FOR/WHILE
        */
        return nOuterLoops;
    }

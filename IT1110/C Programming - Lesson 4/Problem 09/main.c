...
int main(int argc, char *argv[])
{
    ...
    #ifdef FRIENDLY_UX
    printf("Hay nhap vao loai tu lanh va so luong tuong ung: ");
    #endif // FRIENDLY_UX

    scanf("%lld%lld", &sel, &qty);
    switch (sel)
    {
        case 1: amount = type1 * qty; break;
        case 2: amount = type2 * qty; break;
        case 3: amount = type3 * qty; break;
        default: break;
    }

...
//Process
void drawSquare()     //Hinh vuong
{
    FOR(i, 1, n)
    {
        FOR(j, 1, n) pc(ch), pc(sp);
        pc(el);
    }
    pc(el);
}

void drawUpperLeft()  //Trai tren
{
    FOR(i, 1, n)
    {
